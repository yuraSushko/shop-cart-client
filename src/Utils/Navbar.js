...
export  default function Navbar(props)  {
    ...
    return (
        <nav className="d-flex justify-content-start position-fixed navbar">
            <div className="icon">
            ...
            <div className="btn btn position-relative icon">
                <a href="/cart" style={{color: "inherit", width:30, height:30}}>
